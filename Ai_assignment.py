...
def login():
    ...
    if username == "lpu" and password == "lpu123":
        messagebox.showinfo("Success", "Hello User, Welcome to money wallet.")
        root.destroy() 
        open_main_window() 
    else:
...
def open_main_window(): 
    ...
    class PaymentInterface:
        def __init__(self):
            ...
            self.balance_label = Label(self.window, font = ("Segoe print", 20), text=f"Balance: ₹ {self.balance}")
            self.balance_label.place(x=270,y=20)
        ...
        def add_money(self):
            ...
            try:
                ...
                password = simpledialog.askfloat("Add Money", f"You are adding ₹ {recognizer.recognize_google(audio)} \nEnter your password:")
                if password == 12345:
